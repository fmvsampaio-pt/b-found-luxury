...
export const translations = {
  pt: {
    ...
    contact: {
      ...
      address: { title: "Morada", lines: ["Av. Amália Rodrigues 36B", "2650-437 Amadora, Portugal"] },
  ...
  en: {
    ...
    contact: {
      ...
      address: { title: "Address", lines: ["Av. Amália Rodrigues 36B", "2650-437 Amadora, Portugal"] },
